...
Hooks.once('init', function() {
  ...
  Hooks.once('init', async function() {
    console.log('Initializing Divine Awakening System');
  
    // Register Actor Sheets
    Actors.registerSheet('divine-awakening', MortalActorSheet, { makeDefault: false });
    Actors.registerSheet('divine-awakening', AwakenedActorSheet, { makeDefault: false });
